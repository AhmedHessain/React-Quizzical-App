import "../Components-CSS/SVGS.css"
export default function SVGS(){
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 158 141" fill="none" className="top-right-svg">
            ...
            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 148 118" fill="none" className="bottom-left-svg">
